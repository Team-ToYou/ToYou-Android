...
class NoticeRequestBlankAdapter : RecyclerView.Adapter<NoticeRequestBlankAdapter.BlankNoticeViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BlankNoticeViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_notice_request_blank, parent, false)
