...
object FriendDates {
    ...
    fun generateFriendDates(calendar: Calendar, cardNumMap: Map<Pair<Int, Int>, Map<Int, Int>>): List<FriendDate> {
        ...
        for (i in 0 until daysInMonth) {
            ...
            val cardNum = cardNumMap[Pair(year, month)]?.get(day)
            dates.add(FriendDate(cal.time, cardNum.toString()))
            cal.add(Calendar.DAY_OF_MONTH, 1)
        }
